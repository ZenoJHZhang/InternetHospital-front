<template>
  <div>
    <el-container>
      <el-header height="18vmax" style="padding:0">
        <el-carousel height="18vmax">
      ...
      >
        <el-aside style="height:100%;" width="70%">
          <el-container>
            <el-header
            ...
            <el-main style="backgroundColor:white;width:100%;height:420px;margin-bottom:20px">
              <consultation-department></consultation-department>
            </el-main>
            <el-footer style="backgroundColor:white;width:100%;height:100%;padding:20px">
              <expert-appointment></expert-appointment>
            </el-footer>
          </el-container>
        </el-aside>
        <el-main style="backgroundColor:white;margin-left:15px;height:50%">
...
export default {
  ...
  methods: {
    listNetTreatmentRoomCarousel() {
      axion.listNetTreatmentRoomCarousel().then(response => {
        if (response != null) {
          this.imgs = response.data.returnData;
        }
      });
    }
  },
  mounted() {
    this.$nextTick(function generate() {
      ...
      this.listNetTreatmentRoomCarousel();
    });
  }
};
</script>
